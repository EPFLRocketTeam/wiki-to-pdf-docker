...
\newcommand\BackgroundPic{
    \put(0,0){
        \parbox[b][\paperheight]{\paperwidth}{
            \vfill
            \centering
            \includegraphics[width=\paperwidth,height=\paperheight]{/home/jordan/wiki-to-pdf-webapp/src/png/\project_title-page.png}
            \vfill
        }
    }
}
...
\lhead{}
\lhead{\includegraphics[height=1.5cm]{/home/jordan/wiki-to-pdf-webapp/src/png/ert_logo_small.png}\vspace{-4mm}}
\rhead{\includegraphics[height=1.5cm]{/home/jordan/wiki-to-pdf-webapp/src/png/\project_patch.png}\vspace{-4mm}}
