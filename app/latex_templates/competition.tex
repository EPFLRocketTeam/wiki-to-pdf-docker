...
\newcommand\BackgroundPic{
    \put(-3.1pt,0){
        \parbox[b][\paperheight]{\paperwidth}{
            \vfill
            \centering
            \includegraphics[width=\paperwidth,height=\paperheight]{\assetsDirectory/c_title-page.png}
            \vfill
        }
    }
}
...
\rhead{\includegraphics[height=1.5cm]{\assetsDirectory/c_patch.png}\vspace{-4mm}}
