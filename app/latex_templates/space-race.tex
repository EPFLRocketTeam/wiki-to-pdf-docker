...
% If the lineNumbers variable is not set by Pandoc, set it to false by default
\ifdefempty{$lineNumbers$}{\def\lineNumbers{false}}{$lineNumbers$}

% Conditionally enable line numbering based on the value of 'lineNumbers'
\ifx\lineNumbers\true
    \usepackage{lineno}
