...
\IfFileExists{caption.sty}{\usepackage[font=small,skip=0pt]{caption}}{}
...
\IfFileExists{datetime2.sty}{\usepackage[useregional]{datetime2}}{}
\usepackage{longtable}
\usepackage{fancyhdr}
\usepackage{fancyvrb}
\IfFileExists{eso-pic.sty}{\usepackage{eso-pic}}{%
    \newcommand{\AddToShipoutPicture}[1]{}
    \newcommand{\ClearShipoutPicture}{}
}
\IfFileExists{minted.sty}{\usepackage{minted}}{%
    % Fallback when minted is unavailable: map minted env to Verbatim.
    \newenvironment{minted}[2][]{\Verbatim}{\endVerbatim}
}
\IfFileExists{tcolorbox.sty}{\usepackage[most]{tcolorbox}}{%
    % Fallback box environment if tcolorbox is unavailable.
    \newenvironment{tcolorbox}[1][]{\begin{quote}}{\end{quote}}
}
\IfFileExists{fontawesome5.sty}{\usepackage{fontawesome5}}{%
    % Fallback icons used by wiki quote blocks.
    \newcommand{\faInfoCircle}{[i]}
    \newcommand{\faCheckCircle}{[ok]}
...
\providecommand{\sodef}[4]{\newcommand#1[1]{##1}}
\sodef\an{}{.1em}{0.1em}{0.1em}

% FRONT PAGE BACKGROUND IMAGE
% Use a variable so different templates can provide different images.
$if(backgroundImage)$
\newcommand\BackgroundPic{
    \put(-3.1pt,0){
        \parbox[b][\paperheight]{\paperwidth}{
            \vfill
            \centering
            \includegraphics[width=\paperwidth,height=\paperheight]{\assetsDirectory/$backgroundImage$}
            \vfill
        }
    }
}
...
% Background shipout is disabled for compatibility with slim TeX runtimes.
...
$if(rheadImage)$
\rhead{\includegraphics[height=1.5cm]{\assetsDirectory/$rheadImage$}\vspace{-4mm}}
$else$
\rhead{}
$endif$
...
\fancyfoot[L]{\rule[-2ex]{0pt}{2ex}{\bf EPFL ROCKET TEAM }$footerText$}
