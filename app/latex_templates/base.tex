...
\IfFileExists{phvr8t.tfm}{\usepackage[scaled]{helvet}}{}
...
\IfFileExists{eso-pic.sty}{\usepackage{eso-pic}}{%
    \newcommand{\AddToShipoutPictureBG}[1]{}
...
\IfFileExists{fontawesome5.sty}{\usepackage{fontawesome5}}{%
    ...
    \newcommand{\faQuoteLeft}{[\textquotedblleft]}
}
...
\newcommand\BackgroundPic{
    \AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight]{\assetsDirectory/$backgroundImage$}}
}
$endif$
